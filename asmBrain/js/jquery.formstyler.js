...
//        $.fn.styler(el);
	...
	$.fn.styler = function(opt) {
		...
		var opt = $.extend({
			...
			selectSearchNotFound: 'Aucun résultat',
			selectSearchPlaceholder: 'Recherchez...',
				...
				el.each(function() {
					if (el.parent('div.jq-radio').length < 1) {
						...
						function radio() {
							...
							// клик на label
//							el.closest('label').add('label[for="' + el.attr('id') + '"]').click(function(e) {//errors on label click - infinite loop
//								radio.click();
//								e.preventDefault();
//                                $('input:radio').trigger('refresh');
//							});
							...
							function doSelect() {
								...
								.bind('keydown keyup', function(e) {
									...
									if (e.which == 40 || e.which == 39 || e.which == 34) {
										dropdown.scrollTop(dropdown.scrollTop() + li.filter('.selected').position().top - dropdown.innerHeight());
									}
									if (e.which == 13) {
										dropdown.hide();
									}
